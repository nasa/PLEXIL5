...
import org.nianet.plexil.plexilxml2maude.jaxbmodel.ext.NumericalLookupNow;
import org.nianet.plexil.plexilxml2maude.jaxbmodel.ext.NumericalLookupOnChange;
...
@XmlRootElement(name = "NumericRHS")
public class NumericRHS {
    ...
    public ArithmeticExpression getArithmeticExpression(){
    	...
    	//TODO add SQRT support
//    	else if (getSQRT() != null){
//    		return getSQRT();
//    	}
    	//TODO add ABS support
//    	else if (getABS() != null){
//    		return getABS();
//    	}
    	else if (getIntegerVariable() != null){
    		return new NodeVariable(getIntegerVariable());
    	}
    	else if (getRealVariable() != null){
    		return new NodeVariable(getRealVariable());
    	}
    	else if (getIntegerValue() != null){
    		return new NumericalLiteral(getIntegerValue().toString());
    	}
    	else if (getRealValue() != null){
    		return new NumericalLiteral(getRealValue().toString());
    	}
    	else if (getLookupOnChange() != null){
    		return new NumericalLookupOnChange(getLookupOnChange());
    	}
    	else if (getLookupNow() != null){
    		return new NumericalLookupNow(getLookupNow());
    	}   	
    	
    	
    	else{
    		throw new RuntimeException("No valid or supported arithmetic expression found on NumericRHS element:");
    	}
...
//    	}
//    	//TODO
//    	else if (getNodeTimepointValue() != null){
//
//    	}
    }
